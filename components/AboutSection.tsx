...
export default function AboutSection() {
    ...
    return (
        <div id="ueber-mich-section">
            {/* Original Page Header - now integrated as a section */}
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="lg:col-span-8 space-y-8 text-lg text-slate-600 leading-relaxed">
                            ...
                            <div className="bg-stone-50 border-l-4 border-brand-primary p-8 rounded-r-xl my-10">
                                ...
                                <h4 className="text-xl font-bold text-slate-900 mb-3">{t('quote_title')}</h4>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                        <div className="mb-12 lg:mb-0">
                            <h3 className="text-3xl font-display font-bold mb-6">{t('why_title')}</h3>
