...
const faqData = [
    {
        ...
        answer: (
            <>
                Mein erster Fokus liegt auf der Entwicklung maßgeschneiderter <strong>Windows-Applikationen</strong>, die industrielle Prozesse steuern, visualisieren und protokollieren. Im Gegensatz zu Standardlösungen biete ich Software an, die auf einem tiefen Verständnis des Prozesses basiert, einfach und schnell erweiterbar ist und die einfach und sicher mit ihrer Umwelt kommuniziert. Dazu gehören:
